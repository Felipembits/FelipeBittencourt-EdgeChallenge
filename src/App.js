    ...
    <section class="allApp">
      ...
      <div class="aboutAzion">
        <div class="textAboutAzion">
          <h3>
            A plataforma de Edge da Azion oferece soluções para desenvolvedores
            e provedores de serviços, incluindo aplicações serverless, segurança
            zero-trust, otimização da entrega de conteúdo, IoT e virtualização
            de infraestruturas de edge. Isso resulta em melhorias de desempenho
            e segurança, além de economia de mais de 70% em relação a soluções
            legadas.
          </h3>
        </div>
      ...
      <footer>
        <div class="background">
          <ul class="social-media-buttons">
            <li>
              <a
                href="https://www.instagram.com/felipembits/"
                target="_parent"
                title="Instagram"
              >
                <svg
            ...
            <li>
              <a
                href="https://twitter.com/FelipemBits"
                target="_parent"
                title="Twitter"
              >
                <svg
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/felipe-martins-bittencourt-613362273/"
                target="_parent"
                title="Linkedin"
              >
                <svg
